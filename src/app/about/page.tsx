    ...
    <div className="md:max-w-[1298px] px-4 mx-auto">
      ...
      <section className="pb-[80px] md:pb-[200px] px-4 bg-[#FBE0B0]">
        <div className="grid gap-[17.52px] md:gap-[55px] py-[17.52px] md:py-[33.33px] max-w-[1266px] mx-auto">
          ...
          <div id="archibuzz" className="max-w-[1019.27px] flex flex-col items-center gap-4 mx-auto">
        ...
        <div className="grid gap-10 max-w-[1266px] mx-auto">
          ...
          <Link href={'/signup'}>
            <Button
              ...
              styles="bg-[#FFA809] shadow-custom text-[10px] sm:text-[16px] text-white font-medium text-white px-4 py-2 rounded-[12px] md:px-6 md:py-4 md:rounded-[20px] md:h-14 mx-auto hover:bg-[#CC8400] transition ease duration-100ms"
            >
              Get started
            </Button>
          </Link>
      ...
      <section id="archiguide" className="pt-8 pb-16 px-4 bg-[#FFE4B2]">
        <div className="grid gap-10 max-w-[1266px] mx-auto">
      ...
      <section id="designstudios" className="bg-[#f3f3f3] pt-8">
            ...
            <div className="max-w-[455px] mb-5 md:mb-0 flex flex-col md:flex-row justify-between gap-12">
              ...
              <div className="flex flex-col gap-5">
                ...
                <ul className="text-base font-medium leading-8">
                  <li><a href="#archibuzz">ArchiBuzz</a></li>
                  <li><a href="#archiguide">ArchiGuide</a></li>
                  <li><a href="#designstudios">Design Studios</a></li>
                  <li>Buzz AI</li>
                </ul>
              </div>
            </div>
