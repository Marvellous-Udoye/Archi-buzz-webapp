...
const Article = () => {
  ...
  if (loading)
    return (
      <p className="px-4 lg:px-0 max-w-[1266px] mx-auto mt-6">Loading...</p>
    );
  ...
  return (
    <div className="max-w-[1298px] mx-auto px-4 mb-6 sm:mb-8">
      <form className="max-w-[593px] relative mt-8 mb-6">
        ...
        >
          <svg
            className="absolute top-1/2 left-5 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5"
      ...
      <p className="text-[24px] sm:text-[2.5rem] leading-6 sm:leading-[48.8px] font-medium mb-4">
      ...
      <div>
        <p className="text-[24px] sm:text-[2.5rem] leading-[48.8px] font-medium mt-5 sm:my-4">
          Other articles
        </p>
