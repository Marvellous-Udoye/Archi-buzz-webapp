...
const AiTools = async () => {
  ...
  return (
    <div className="py-8 px-4">
      <div className="grid gap-[8.99px] max-w-7xl mx-auto md:gap-[16.67px] border md:border-[.83px] border-solid border-[#80808040] rounded-[4.5px] sm:rounded-[16.67px] py-8 px-5 mb-10 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
